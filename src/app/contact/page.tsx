          ...
          <div className="grid gap-12 lg:grid-cols-5">
            <div className="lg:col-span-2">
              ...
              <div className="mt-8 space-y-6">
                ...
                <div>
                  <h3 className="text-sm font-semibold uppercase tracking-wider text-navy/60">WhatsApp</h3>
                  <a href="https://wa.me/441234567890" target="_blank" rel="noopener noreferrer" className="mt-1 flex items-center gap-3 text-lg font-medium text-navy transition-colors hover:text-amber">
                ...
                <div>
                  ...
                  <a href="mailto:hello@intobuild.co.uk" className="mt-1 flex items-center gap-3 text-lg font-medium text-navy transition-colors hover:text-amber">
                    <svg className="h-5 w-5 text-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
